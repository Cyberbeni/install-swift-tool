    ...
    buildTool() {
        return __awaiter(this, void 0, void 0, function* () {
            yield core.group('Building tool', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const additionalOptions = yield helpers_1.supportedBuildOptions(['--disable-sandbox', '--disable-automatic-resolution', '--disable-index-store', '--disable-package-manifest-caching', '--disable-prefetching']);
