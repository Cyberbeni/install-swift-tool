...
class SwiftToolInstaller {
    ...
    resolveVersion() {
        return __awaiter(this, void 0, void 0, function* () {
            yield core.group('Resolving version requirement', () => __awaiter(this, void 0, void 0, function* () {
                const versions = (yield helpers_1.exec('git', ['ls-remote', '--refs', '--tags', this.url])).split('\n').map(function (value) {
                    var _a;
    ...
    cloneGit() {
        return __awaiter(this, void 0, void 0, function* () {
            yield core.group('Cloning repo', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const commitHash = (_a = (yield helpers_1.exec('git', ['-C', this.workingDirectory, 'show-ref', '-s'])).split('\n').pop()) !== null && _a !== void 0 ? _a : '';
    ...
    buildTool() {
        return __awaiter(this, void 0, void 0, function* () {
            yield core.group('Building tool', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const additionalOptions = yield helpers_1.supportedBuildOptions(['--disable-sandbox']);
                yield helpers_1.exec('swift', ['build', '--package-path', this.workingDirectory, '--configuration', 'release'].concat(additionalOptions));
            }));
        });
    }
    tryToCleanupIntermediateBuildProducts() {
        return __awaiter(this, void 0, void 0, function* () {
            yield core.group('Trying to delete intermediate build products', () => __awaiter(this, void 0, void 0, function* () {
                try {
    ...
    install() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.didRestore) {
                ...
                if (this.useCache) {
                    yield this.tryToCleanupIntermediateBuildProducts();
    ...
    static install(url, branch = '', version = '', useCache = true) {
        return __awaiter(this, void 0, void 0, function* () {
