...
class SwiftToolInstaller {
    ...
    cleanupIntermediateBuildProducts() {
        return __awaiter(this, void 0, void 0, function* () {
            yield core.group('Deleting intermediate build products', () => __awaiter(this, void 0, void 0, function* () {
                try {
    ...
    install() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.didRestore) {
                ...
                if (this.useCache) {
                    yield this.cleanupIntermediateBuildProducts();
