...
function resolve_version() {
    return __awaiter(this, void 0, void 0, function* () {
        yield core.group('Resolving version requirement', () => __awaiter(this, void 0, void 0, function* () {
            let versions = (yield helpers_1.better_exec('git', ['ls-remote', '--refs', '--tags', url]))
                .split('\n')
                .map(function (value) {
                var _a;
...
function create_working_directory() {
    return __awaiter(this, void 0, void 0, function* () {
        yield core.group('Creating working directory', () => __awaiter(this, void 0, void 0, function* () {
            let commitHash = '';
            if (branch) {
                commitHash = yield helpers_1.better_exec('git', ['ls-remote', '-ht', url, `refs/heads/${branch}`, `refs/tags/${branch}`]);
            }
            else {
                commitHash = yield helpers_1.better_exec('git', ['ls-remote', url, `HEAD`]);
            }
            commitHash = commitHash.substring(0, 39);
            const swiftVersion = yield helpers_1.better_exec('swift', ['-version']);
